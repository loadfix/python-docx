...
class _BaseChildElement:
    ...
    def _add_adder(self):
        ...
        _add_child.__doc__ = (
            f"Add a new ``<{self._nsptagname}>`` child element unconditionally,"
            f" inserted in the correct sequence."
        )
    ...
    def _add_creator(self):
        ...
        creator.__doc__ = (
            f'Return a "loose", newly created ``<{self._nsptagname}>`` element'
            f" having no attributes, text, or children."
        )
    ...
    def _add_inserter(self):
        ...
        _insert_child.__doc__ = (
            f"Return the passed ``<{self._nsptagname}>`` element after inserting"
            f" it as a child in the correct sequence."
        )
    ...
    def _list_getter(self):
        ...
        get_child_element_list.__doc__ = (
            f"A list containing each of the ``<{self._nsptagname}>`` child"
            f" elements, in the order they appear."
        )
...
class Choice(_BaseChildElement):
    ...
    def _add_get_or_change_to_method(self):
        ...
        get_or_change_to_child.__doc__ = (
            f"Return the ``<{self._nsptagname}>`` child, replacing any other"
            f" group element if found."
        )
...
class ZeroOrOne(_BaseChildElement):
    ...
    def _add_get_or_adder(self):
        ...
        get_or_add_child.__doc__ = (
            f"Return the ``<{self._nsptagname}>`` child element, newly added"
            f" if not present."
        )
