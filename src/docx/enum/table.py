...
# -- WD_BORDER_STYLE is defined once in docx.enum.text and re-exported here --
# -- to resolve the historical duplication (see GitHub #165). Both names refer --
# -- to the same enum object so cross-module comparisons work correctly. --
from docx.enum.text import WD_BORDER_STYLE as WD_BORDER_STYLE  # noqa: F401
